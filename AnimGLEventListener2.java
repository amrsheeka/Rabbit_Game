...
//
//        int sec = Integer.parseInt((java.time.LocalTime.now()).toString().substring(6, 8)),
//                min = Integer.parseInt((java.time.LocalTime.now()).toString().substring(3, 5));
//
//       //String time1 = time;
...
//
//        String fi = String.format("%02d:%02d", TimeUnit.MILLISECONDS.toMinutes(diffrence),
//                 TimeUnit.MILLISECONDS.toSeconds(diffrence) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(diffrence)));
//
//        renderer.beginRendering(gldd.getWidth(), gldd.getHeight());
//        renderer.draw(fi, 40, 40);
...
//        String fi = String.format("%02d", time );
//       renderer.beginRendering(gldd.getWidth(), gldd.getHeight());
//        renderer.draw(fi, 40, 40);
//        renderer.endRendering();
    }
...
//                DrawSprite(gl, 600, 200, 5, 1);
//                //rabbit
//                DrawSprite(gl, arrx[index], arry[index] + 100, 4, 1);
//
//                //hammer
//                Drawsword(gl, xx, yy - 50, 6, 1);
//
//                x = arrx[index];
//                y = arry[index] + 100;
//    
...
//                DrawSprite(gl, 600, 200, 5, 1);
//                //rabbit
//                DrawSprite(gl, arrx2[index], arry2[index] + 100, 4, 1);
//
//                //hammer
//                Drawsword(gl, xx, yy - 50, 6, 1);
//
...
//                 DrawSprite(gl, 820, 160, 5, 1);
//                //rabbit
//                DrawSprite(gl, arrx3[index], arry3[index] + 100, 4, 1);
//
//                //hammer
//                Drawsword(gl, xx, yy - 50, 6, 1);
//
